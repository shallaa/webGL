...
'                       gl.vertexAttribPointer(tProgram.aVertexPosition, 4, gl.FLOAT, false, 4*Float32Array.BYTES_PER_ELEMENT, 0*Float32Array.BYTES_PER_ELEMENT); \n' +
//'                       gl.vertexAttribPointer(tProgram.aVertexPosition,tVBO.size, gl.FLOAT, false, 6*Float32Array.BYTES_PER_ELEMENT, 0*Float32Array.BYTES_PER_ELEMENT) \n' +
//'                       gl.vertexAttribPointer(tProgram.aVertexPosition2,tVBO.size, gl.FLOAT, false, 6*Float32Array.BYTES_PER_ELEMENT, 3*Float32Array.BYTES_PER_ELEMENT) \n' +
