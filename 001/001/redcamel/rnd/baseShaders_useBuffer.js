...
'                       gl.vertexAttribPointer(tProgram.aVertexPosition, 4, gl.FLOAT, false, 11*Float32Array.BYTES_PER_ELEMENT, 0*Float32Array.BYTES_PER_ELEMENT); \n' +
'                       gl.vertexAttribPointer(tProgram.aUniformID, 1, gl.FLOAT, false,11*Float32Array.BYTES_PER_ELEMENT, 4*Float32Array.BYTES_PER_ELEMENT); \n' +
'                       gl.vertexAttribPointer(tProgram.aRotation, 3, gl.FLOAT, false,11*Float32Array.BYTES_PER_ELEMENT, 5*Float32Array.BYTES_PER_ELEMENT); \n' +
'                       gl.vertexAttribPointer(tProgram.aPosition, 3, gl.FLOAT, false, 11*Float32Array.BYTES_PER_ELEMENT, 8*Float32Array.BYTES_PER_ELEMENT); \n'
