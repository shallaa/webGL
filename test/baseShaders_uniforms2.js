...
'                       var j=maxUniform\n' +
'                       while(j--){\n' +
'                           gl.uniform3fv(tProgram["uPositions["+j+"]"], imsi[j]) \n' +
'                           imsi2[j][0] += 0.01 \n' +
'                           imsi2[j][1] += 0.01 \n' +
'                           imsi2[j][2] += 0.01 \n' +
'                           gl.uniform3fv(tProgram["uRotations["+j+"]"], imsi2[j]) \n' +
'                       }\n' +
'                       gl.uniform3fv(tProgram.uPosition, target.position) \n' +
'                       gl.uniform3fv(tProgram.uRotation, target.rotation) \n' +
'target.rotation[0]+=0.002\n' +
'target.rotation[1]+=0.002\n' +
'target.rotation[2]+=0.002\n'
